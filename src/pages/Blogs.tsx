...
const blogs = [
  {
    ...
    platform: "Medium",
    icon: <FaMedium />,
    link: "https://medium.com/@chintuGajula96/make-your-rails-console-look-better-510988d40566",
  ...
  },
  {
    ...
    platform: "Medium",
    icon: <FaMedium />,
    link: "https://medium.com/@chintuGajula96/docker-fundas-my-version-7b9262bd90d4",
  ...
  },
  {
    ...
    platform: "Dev.to",
    icon: <FaDev />,
    link: "https://dev.to/GajulaVighnesh0262/grape-gem-in-ruby-on-rails-handling-user-model-and-api-endpoint-g6d",
